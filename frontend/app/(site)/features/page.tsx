...
const features = [
  ...
  {
    title: 'Typed CMS access',
    description: 'Keep the Payload integration narrow so the content layer stays replaceable.'
  }
];
  ...
  return (
    <div className="pb-16">
      <PageIntro
        ...
        description="A small set of pieces for content-driven sites, demo pages, and a simple CMS-backed frontend."
      />
